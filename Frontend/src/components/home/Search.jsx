...
const Search = () => {
    ...
    // DO NOT put a closing } brace here
    ...
    return (
        <div className='searchbar'>
            <input
                ...
                type='text'
                value={keyword.city || ''} // Good practice to default to '' for controlled inputs
            ...
            <input
                ...
                type='number'
                value={keyword.guests || ''} // Good practice to default to '' for controlled inputs
...
} // <--- This is the correct, and only, closing brace for the Search component
